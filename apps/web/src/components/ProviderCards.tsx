...
export function ProviderCards({ selected, onSelect }: ProviderCardsProps) {
  return (
        ...
        {providers.map(provider => (
          ...
          >
            <span className="provider-card__top">
              ...
              <span className={provider.available ? 'status status--ready' : 'status'}>
                {provider.available ? zhCN.providerAvailable : zhCN.providerUnavailable}
              </span>
            </span>
